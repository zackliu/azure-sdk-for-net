...
{
    public class WebPubSubForSocketIOAsyncCollectorTests
    {
        ...
        public WebPubSubForSocketIOAsyncCollectorTests()
        {
        }
        ...
        {
            _socketLifetimeStore.AddSocket("socket1", "/ns", "conn1");
            await _collector.AddAsync(WebPubSubForSocketIOAction.CreateAddSocketToRoomAction("/ns", "socket1", "rm1"));
        ...
        {
            _socketLifetimeStore.AddSocket("socket1", "/ns", "conn1");
            await _collector.AddAsync(WebPubSubForSocketIOAction.CreateRemoveSocketFromRoomAction("/ns", "socket1", "rm1"));
