...
namespace Azure.Messaging.WebPubSub.Client
{
    ...
    /// </summary>
    public class WebPubSubJsonReliableProtocol : IWebPubSubProtocol
    {
        ...
        /// </summary>
        public string Name => "json.reliable.webpubsub.azure.v1";

        /// <summary>
        /// Get whether the protocol using a reliable subprotocl.
        /// </summary>
        public bool IsReliableSubProtocol => true;
